...
struct  OGActionType_t1978093408 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(OGActionType_t1978093408, ___value___1)); }
