...
{
	typedef void (*Action)(void*, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, const MethodInfo*);

	static inline void Invoke (Il2CppMethodSlot slot, Il2CppClass* declaringInterface, void* obj, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, T10 p10, T11 p11, T12 p12, T13 p13, T14 p14)
	{
		VirtualInvokeData invokeData;
		il2cpp_codegen_get_interface_invoke_data (slot, declaringInterface, obj, &invokeData);
