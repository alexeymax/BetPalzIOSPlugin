...
#include "Facebook_Unity_IOS_U3CModuleU3E3783534214MethodDeclarations.h"
#include "Facebook_Unity_IOS_Facebook_Unity_IOS_IOSWrapper294756590.h"
#include "Facebook_Unity_IOS_Facebook_Unity_IOS_IOSWrapper294756590MethodDeclarations.h"
...
extern "C"  void IOSWrapper_CreateGameGroup_m2666235053 (IOSWrapper_t294756590 * __this, int32_t ___requestId0, String_t* ___name1, String_t* ___description2, String_t* ___privacy3, const MethodInfo* method)
{
	{
		int32_t L_0 = ___requestId0;
		String_t* L_1 = ___name1;
		String_t* L_2 = ___description2;
		String_t* L_3 = ___privacy3;
		IOSWrapper_IOSFBCreateGameGroup_m1363285378(NULL /*static, unused*/, L_0, L_1, L_2, L_3, /*hidden argument*/NULL);
		return;
	}
}
// System.Void Facebook.Unity.IOS.IOSWrapper::JoinGameGroup(System.Int32,System.String)
extern "C"  void IOSWrapper_JoinGameGroup_m3292073363 (IOSWrapper_t294756590 * __this, int32_t ___requestId0, String_t* ___groupId1, const MethodInfo* method)
{
	{
		int32_t L_0 = ___requestId0;
		String_t* L_1 = ___groupId1;
		IOSWrapper_IOSFBJoinGameGroup_m1281811042(NULL /*static, unused*/, L_0, L_1, /*hidden argument*/NULL);
		return;
	}
}
...
extern "C" void DEFAULT_CALL IOSFBCreateGameGroup(int32_t, char*, char*, char*);
// System.Void Facebook.Unity.IOS.IOSWrapper::IOSFBCreateGameGroup(System.Int32,System.String,System.String,System.String)
extern "C"  void IOSWrapper_IOSFBCreateGameGroup_m1363285378 (Il2CppObject * __this /* static, unused */, int32_t ___requestId0, String_t* ___name1, String_t* ___description2, String_t* ___privacy3, const MethodInfo* method)
{
	...
	// Marshaling of parameter '___description2' to native representation
	char* ____description2_marshaled = NULL;
	____description2_marshaled = il2cpp_codegen_marshal_string(___description2);

	// Marshaling of parameter '___privacy3' to native representation
	char* ____privacy3_marshaled = NULL;
	____privacy3_marshaled = il2cpp_codegen_marshal_string(___privacy3);

	// Native function invocation
	reinterpret_cast<PInvokeFunc>(IOSFBCreateGameGroup)(___requestId0, ____name1_marshaled, ____description2_marshaled, ____privacy3_marshaled);
	...
	// Marshaling cleanup of parameter '___description2' native representation
	il2cpp_codegen_marshal_free(____description2_marshaled);
	____description2_marshaled = NULL;

	// Marshaling cleanup of parameter '___privacy3' native representation
	il2cpp_codegen_marshal_free(____privacy3_marshaled);
	____privacy3_marshaled = NULL;

}
extern "C" void DEFAULT_CALL IOSFBJoinGameGroup(int32_t, char*);
// System.Void Facebook.Unity.IOS.IOSWrapper::IOSFBJoinGameGroup(System.Int32,System.String)
extern "C"  void IOSWrapper_IOSFBJoinGameGroup_m1281811042 (Il2CppObject * __this /* static, unused */, int32_t ___requestId0, String_t* ___groupId1, const MethodInfo* method)
{
	typedef void (DEFAULT_CALL *PInvokeFunc) (int32_t, char*);

	// Marshaling of parameter '___groupId1' to native representation
	char* ____groupId1_marshaled = NULL;
	____groupId1_marshaled = il2cpp_codegen_marshal_string(___groupId1);

	// Native function invocation
	reinterpret_cast<PInvokeFunc>(IOSFBJoinGameGroup)(___requestId0, ____groupId1_marshaled);

	// Marshaling cleanup of parameter '___groupId1' native representation
	il2cpp_codegen_marshal_free(____groupId1_marshaled);
	____groupId1_marshaled = NULL;
