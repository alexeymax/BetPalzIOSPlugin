...
extern "C"  PropertyInfoU5BU5D_t1736152084* TypeBuilder_GetProperties_m2211539685 (TypeBuilder_t3308873219 * __this, int32_t ___bindingAttr0, const MethodInfo* method)
{
	...
	}
	{
		...
		int32_t L_2 = ___bindingAttr0;
		NullCheck(L_1);
		PropertyInfoU5BU5D_t1736152084* L_3 = VirtFuncInvoker1< PropertyInfoU5BU5D_t1736152084*, int32_t >::Invoke(53 /* System.Reflection.PropertyInfo[] System.Type::GetProperties(System.Reflection.BindingFlags) */, L_1, L_2);
		return L_3;
	}
...
extern "C"  TypeU5BU5D_t1664964607* TypeBuilder_GetGenericArguments_m3241780469 (TypeBuilder_t3308873219 * __this, const MethodInfo* method)
{
	...
	TypeU5BU5D_t1664964607* V_0 = NULL;
	{
		GenericTypeParameterBuilderU5BU5D_t358971386* L_0 = __this->get_generic_params_20();
		if (L_0)
		{
			goto IL_000d;
		}
...
IL_000d:
	{
		GenericTypeParameterBuilderU5BU5D_t358971386* L_1 = __this->get_generic_params_20();
		NullCheck(L_1);
		...
		GenericTypeParameterBuilderU5BU5D_t358971386* L_2 = __this->get_generic_params_20();
		TypeU5BU5D_t1664964607* L_3 = V_0;
