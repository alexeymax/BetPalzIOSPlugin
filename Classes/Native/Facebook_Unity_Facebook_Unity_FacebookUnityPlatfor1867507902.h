...
struct  FacebookUnityPlatform_t1867507902 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(FacebookUnityPlatform_t1867507902, ___value___1)); }
